...
<body>
  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="h-100 w-100" src="https://i.pinimg.com/564x/3a/39/29/3a39290a2f27da1e36a836f19abb8a45.jpg"
          class="d-block w-100" alt="...">
        <div class="carousel-caption h-100 d-block">
          <h2><span>ALL SCHOOL SITE</span></h2>
          <p>a place you can find the school of your dream.</p>
        </div>
      </div>
      <div class="carousel-item">
        <img class="h-100 w-100" src="https://i.pinimg.com/564x/43/80/7e/43807e3b296aba05332e66574ac6dbf6.jpg"
          class="d-block w-100" alt="...">
        <div class="carousel-caption h-100 d-block">
          <h2><span>ALL SCHOOL SITE</span></h2>
          <p>a place you can find the school of your dream.</p>
      ...
      <div class="carousel-item">
        <img class="h-100 w-100" src="https://i.pinimg.com/564x/15/09/96/150996d5036e9230edc3fc48decaecd4.jpg"
          class="d-block w-100" alt="...">
        <div class="carousel-caption h-100 d-block">
          <h2><span>ALL SCHOOL SITE</span></h2>
          <p>a place you can find the school of your dream.</p>
  ...
  <!--carousel end-->
<!--contact us-->
<main class="mt-5 text-align center">
  <div class="container">
    <!--section Head start-->
